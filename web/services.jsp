...
<%@ page import="model.entity.RepHistory" %><%--
    ...
    <section id="patientList">
        ...
        <div class="container-fluid col-sm-10">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <%
                    ArrayList<RepHistory> result = (ArrayList<RepHistory>) request.getAttribute("result");
                    for (RepHistory repHistory : result) {
                        out.print("<tr>");
                            out.print("<td>");
                            out.print(repHistory.getRoom_id());
                            out.print("</td>");

                            out.print("<td>");
                            out.print(repHistory.getPersonnelfName());
                            out.print("</td>");

                            out.print("<td>");
                            out.print(repHistory.getPersonnellName());
                            out.print("</td>");

                            out.print("<td>");
                            out.print(repHistory.getTitle());
                            out.print("</td>");

                            out.print("<td>");
                            out.print(repHistory.getDate());
                            out.print("</td>");

                            out.print("<td>");
                            out.print(repHistory.getDescription());
                            out.print("</td>");
