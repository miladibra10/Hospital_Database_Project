...
<style>
    ...
    #intro {
        background: linear-gradient(45deg, rgba(29, 224, 153, 0.8), rgba(29, 200, 205, 0.8)), url("static/img/Doctor.jpg") center top no-repeat;
    }
...
<footer id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <nav class="footer-links text-sm-right text-center pt-2 pt-lg-0">
